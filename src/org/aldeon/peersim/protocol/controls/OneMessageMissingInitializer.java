 ...
 */
public class OneMessageMissingInitializer implements Control {
    private static final String PAR_TOTAL_NUM_MSGS = "totalNumMessages";
    private static final String PAR_PROT = "protocol";
    private final int totalNumMessages;
    ...
    public OneMessageMissingInitializer(String prefix) {
        ...
        this.seed = Configuration.getLong("random.seed");
    }
